...
export default function OrganizationSettings() {
  ...
  const handleSaveColors = async () => {
    try {
      // Actualizar los colores en settings manteniendo todos los demás datos
      const updatedSettings = {
        ...settings, // Mantener todos los datos existentes
  ...
  const handleStampUpload = async () => {
    ...
    try {
      ...
      // También actualizar invoiceSettings para mantener consistencia
  ...
  const handleSaveInvoiceSettings = async () => {
    try {
      ...
      const settingsData = {
        ...settings, // Mantener todos los datos existentes
        ...invoiceSettings // Sobreescribir solo los datos de factura
      };
      
      await api.put('/organizations/me/settings', settingsData);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Actualizar settings manteniendo TODOS los datos
      await api.put('/organizations/me/settings', {
        ...settings,
        ...invoiceSettings, // Incluir datos de factura
        logo_url
      });
