...
const Clients = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!formData.rnc || !formData.rnc.trim()) {
        showError('El RNC/Cédula es obligatorio');
        return;
      }
      ...
      const cleanedData = {
        ...formData,
        rnc: formData.rnc.trim(),  // RNC es obligatorio
        email: formData.email?.trim() || null,  // Email es opcional
